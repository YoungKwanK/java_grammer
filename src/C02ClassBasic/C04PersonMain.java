...
//        printMember1(name1, email1, age1);
        // 위와 같은 방식의 문제점
        // 어떤 요소(속성)들이 그룹화되어 있지 않다보니, 중복이 발생하고 코드의 가독성이 저하

//        // 위와 같은 문제점을 해결하기 위해 클래스의 속성을 정의하고, 객체로 생성하여 그룹화.
...
//        printMember2(p1);
//
//        // Person의 변수값이 public으로 오픈되어 있을 경우 다른 클래스(패키지)에서 너무 편하게 변경 가능
//        p2.name = "hongildong2";
//        printMember2(p2);
...
//        System.out.println("이름은: " + name + " 이메일은: " + email + " 나이는: " + age);
    ...
    public static  void printMember2(C04Person person) { // 넘어온 person은 객체의 주소값이 매개변수로 전달
