...
public class C06AbstractMain {
    public static void main(String[] args) {
        ...
        // 추상 클래스는 구현체없는 메서드가 있으므로, 기본적으로 객체 생성 불가능
//        AbstractAnimal a1 = new AbstractAnimal();

        // 객체의 실체가 dog 클래스를 통해 만들어지므로, 여기서는 d2의 makesound2를 사용가능
...
// 추상 메서드가 하나라도 있으면 반드시 클래스에도 abstract 키워드를 붙이고, 추상클래스가 됨.
abstract class AbstractAnimal{
    void makeSound(){
        System.out.println("동물은 소리를 냅니다.");
    }
    
    // 메서드를 선언만하고 구현이 없는 메서드 선언 시 abstract키워드 사용
...
// final 키워드가 붙은 class는 상속 불가. final키워드가 붙은 메서드는 overriding불가.
